...
// "if else" заменено на "if", "else" убрано за ненадобностью
// изменены имена переменных и имена параметров в соответствии с mixedCaps
// упрощено вычисление randint()
...
// изменены имена переменных, имя функции и имена параметров в соответствии с mixedCaps
...
// изменены имена переменных и имя функции в соответствии с mixedCaps
...
// изменены имена переменных в соответствии с mixedCaps
func main() {
